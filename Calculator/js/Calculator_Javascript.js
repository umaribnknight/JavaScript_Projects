...
function Handle_Operator(Next_Operator)  {
    ...
    //displayed on the screen to a number and then store the result in//Calculator.First_Operand if it doesn't already exist
    ...
    keys.addEventListener('click', (event) => {
        ...
        // that was clicked
        const { target } = event;
        // if the elemnt that was clicked on is not a button, exit the function
